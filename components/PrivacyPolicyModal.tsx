...
const PrivacyPolicyModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div 
        className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col" 
      ...
      >
        ...
        <div className="p-4 sm:p-6 overflow-y-auto text-slate-600 dark:text-gray-300 space-y-4">
            <p className="text-sm text-slate-400 dark:text-gray-500">Last updated: July 2024</p>

            <h3 className="font-semibold text-slate-800 dark:text-white">Introduction</h3>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">Information We Handle</h3>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">Third-Party Services</h3>
            <p>The application uses the Google Gemini API to provide its AI-powered features. When you use these features, your prompts and API key are sent directly to Google. Your use of these features is subject to <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-indigo-500 dark:text-indigo-400 hover:underline">Google's Privacy Policy</a>.</p>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">Changes to This Privacy Policy</h3>
