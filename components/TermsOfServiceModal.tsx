    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in" onClick={onClose}>
      ...
      >
        ...
        <div className="p-4 sm:p-6 overflow-y-auto text-slate-700 space-y-4">
            ...
            <h3 className="font-semibold text-slate-800">1. Acceptance of Terms</h3>
            ...
            <h3 className="font-semibold text-slate-800">2. Description of Service</h3>
            ...
            <h3 className="font-semibold text-slate-800">3. User Responsibilities</h3>
            ...
            <h3 className="font-semibold text-slate-800">4. Disclaimer of Warranties</h3>
