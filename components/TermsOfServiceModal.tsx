    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="p-4 sm:p-6 overflow-y-auto text-slate-600 dark:text-gray-300 space-y-4">
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">1. Acceptance of Terms</h3>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">2. Description of Service</h3>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">3. User Responsibilities</h3>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">4. Disclaimer of Warranties</h3>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">5. Limitation of Liability</h3>
            ...
            <h3 className="font-semibold text-slate-800 dark:text-white">6. Changes to Terms</h3>
