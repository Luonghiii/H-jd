    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="text-center">
                <h2 className="text-2xl font-bold text-white">Ôn luyện</h2>
                <p className="text-gray-400 mt-1">Chọn một phương pháp để củng cố từ vựng của bạn.</p>
            </div>
                ...
                {learnOptions.map(mode => (
                    ...
                    >
                        <div className="flex justify-between items-start">
                           <mode.icon className="w-8 h-8 text-indigo-400" />
