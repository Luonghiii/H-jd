    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-gradient-to-br dark:from-gray-900 dark:to-slate-800 p-4">
      <div className="w-full max-w-lg">
        <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-500 dark:text-gray-400 mt-2 text-center">Để sử dụng các tính năng AI, vui lòng cung cấp khóa API Google Gemini của bạn.</p>
        </div>

        <div className="bg-white dark:bg-slate-900/50 backdrop-blur-sm rounded-xl shadow-2xl shadow-slate-300 dark:shadow-slate-900/50 border border-slate-200 dark:border-slate-700 p-8">
          <h2 className="text-2xl font-bold text-center text-slate-900 dark:text-white mb-6">Cài đặt API Key</h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="apiKey" className="block text-sm font-medium text-slate-600 dark:text-gray-300 mb-1">
              ...
              <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    required
                    autoFocus
                />
              </div>
               <p className="text-xs text-slate-500 dark:text-gray-500 mt-2">
                ...
                Bạn có thể nhận khóa của mình từ <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-indigo-500 dark:text-indigo-400 hover:underline">Google AI Studio</a>.
              </p>
            </div>
