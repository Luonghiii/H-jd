...
const AiTutor: React.FC<AiTutorProps> = ({ onBack }) => {
    const { learningLanguage, uiLanguage, userApiKeys, aiTutorHistory, saveTutorSession, clearTutorHistory, addXp } = useSettings();
    ...
    }, [saveTutorSession, addHistoryEntry, addXp]);
